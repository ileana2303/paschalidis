      ...
      <div className="flex items-center gap-2">
        {currentPage > 2 && (
          <button
            ...
            className="flex w-10 items-center justify-center h-10 rounded-lg text-sm font-medium text-gray-700 hover:bg-blue-500/8 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-500"
          >
            1
          </button>
        )}
        ...
        {currentPage < totalPages - 1 && (
          <button
            ...
            className="flex w-auto min-w-10 items-center justify-center h-10 rounded-lg px-2 text-sm font-medium text-gray-700 hover:bg-blue-500/8 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-500"
          >
            {totalPages}
          </button>
        )}
